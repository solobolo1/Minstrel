#!/bin/bash
NAME="minstrel"                             # Name of the application
DJANGODIR=/home/django/Minstrel/WebsiteMusic/Website               # Django project directory
SOCKFILE=/home/django/env/run/gunicorn.sock  # we will communicte using this unix socket
